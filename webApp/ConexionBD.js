                    ...
                    <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-34 u-layout-cell-2">
                      <div class="u-container-layout u-valign-top u-container-layout-2">
                        ...
                        <h5 class="u-text u-text-14">PADECIMIENTOS</h5> ${pacienteHTML}
                          <h5 class="u-text u-text-15">Resumen de la última sesión</h5>
                          <p></p>
                          ...
                          <p class="u-text u-text-16" align = "justify">${respuesta[0].Resumen}</p>
                           ...
                           <form class="form-style1" action="/grabarAudioPantalla" method="post">
                             <button type="submit" name="Expediente" id="Expediente" value="${respuesta[0].No_Expediente}" class="btn btn-primary u-border-none u-btn-rectangle u-button-style u-custom-color-3 u-hover-palette-3-base">Iniciar sesión terapéutica</button>
                           </form>
                         </div> 
